...
<head>
	<meta charset="utf-8">
	<title>Commerce Backend</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Commerce Backend">
...
<body class=" ">
    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="index.htm"><span class="eternal">Eternal</span> Magic</a>
        </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<p><img src="assets/img/loader.gif" style="margin-right: 3px;" alt="Loading" />Loading Contents</p>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<script>
	$('#loading').modal({backdrop:'static', show:false});
	$('#sidebar li a').on('click', function(){
		if (!$(this).next().hasClass('acc-menu')) {
			$('#loading').modal('show');
